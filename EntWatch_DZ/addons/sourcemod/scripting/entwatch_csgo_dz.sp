...
public void OnPluginStart()
{
	...
	g_hCvar_Delay_Use   = CreateConVar("entwatch_delay_use", "0.0", "Change delay before use", _, true, 0.0, true, 60.0);
...
{
	PrintToServer("ENTWATCH START ROUND ");
...
public Action ZR_OnClientInfect(int& iClient, int& attacker, bool& motherInfect, bool& respawnOverride, bool& respawn)
{
	if (g_bConfigLoaded && motherInfect)
	{
		for (int i = 0; i < g_ItemList.Length; i++)
		{
			class_ItemList ItemTest;
...
stock void LoadConfig()
{
	...
	if (KvGotoFirstSubKey(hKeyValues))
	{
		do
		{
			...
			if (StrEqual(sBuffer_temp, "{green}", false))
			{
				NewItem.GlowColor[0] = 0;
				NewItem.GlowColor[1] = 255;
				NewItem.GlowColor[2] = 0;
			}
			else if (StrEqual(sBuffer_temp, "{default}", false)) {
				NewItem.GlowColor[0] = 255;
				NewItem.GlowColor[1] = 255;
				NewItem.GlowColor[2] = 255;
			}
			else if (StrEqual(sBuffer_temp, "{darkred}", false)) {
				NewItem.GlowColor[0] = 175;
				NewItem.GlowColor[1] = 0;
				NewItem.GlowColor[2] = 0;
			}
			else if (StrEqual(sBuffer_temp, "{purple}", false)) {
				NewItem.GlowColor[0] = 128;
				NewItem.GlowColor[1] = 0;
				NewItem.GlowColor[2] = 128;
			}
			else if (StrEqual(sBuffer_temp, "{lightgreen}", false)) {
				NewItem.GlowColor[0] = 104;
				NewItem.GlowColor[1] = 238;
				NewItem.GlowColor[2] = 104;
			}
			else if (StrEqual(sBuffer_temp, "{lime}", false)) {
				NewItem.GlowColor[0] = 119;
				NewItem.GlowColor[1] = 234;
				NewItem.GlowColor[2] = 7;
			}
			else if (StrEqual(sBuffer_temp, "{red}", false)) {
				NewItem.GlowColor[0] = 255;
				NewItem.GlowColor[1] = 30;
				NewItem.GlowColor[2] = 30;
			}
			else if (StrEqual(sBuffer_temp, "{grey}", false)) {
				NewItem.GlowColor[0] = 128;
				NewItem.GlowColor[1] = 128;
				NewItem.GlowColor[2] = 128;
			}
			else if (StrEqual(sBuffer_temp, "{olive}", false)) {
				NewItem.GlowColor[0] = 112;
				NewItem.GlowColor[1] = 130;
				NewItem.GlowColor[2] = 56;
			}
			else if (StrEqual(sBuffer_temp, "{a}", false)) {
				NewItem.GlowColor[0] = 192;
				NewItem.GlowColor[1] = 192;
				NewItem.GlowColor[2] = 192;
			}
			else if (StrEqual(sBuffer_temp, "{lightblue}", false)) {
				NewItem.GlowColor[0] = 93;
				NewItem.GlowColor[1] = 130;
				NewItem.GlowColor[2] = 255;
			}
			else if (StrEqual(sBuffer_temp, "{blue}", false)) {
				NewItem.GlowColor[0] = 0;
				NewItem.GlowColor[1] = 0;
				NewItem.GlowColor[2] = 255;
			}
			else if (StrEqual(sBuffer_temp, "{d}", false)) {
				NewItem.GlowColor[0] = 102;
				NewItem.GlowColor[1] = 153;
				NewItem.GlowColor[2] = 204;
			}
			else if (StrEqual(sBuffer_temp, "{pink}", false)) {
				NewItem.GlowColor[0] = 255;
				NewItem.GlowColor[1] = 105;
				NewItem.GlowColor[2] = 180;
			}
			else if (StrEqual(sBuffer_temp, "{darkorange}", false)) {
				NewItem.GlowColor[0] = 240;
				NewItem.GlowColor[1] = 94;
				NewItem.GlowColor[2] = 35;
			}
			else if (StrEqual(sBuffer_temp, "{orange}", false)) {
				NewItem.GlowColor[0] = 255;
				NewItem.GlowColor[1] = 140;
				NewItem.GlowColor[2] = 0;
			}
			else if (StrEqual(sBuffer_temp, "{white}", false)) {
				NewItem.GlowColor[0] = 255;
				NewItem.GlowColor[1] = 255;
				NewItem.GlowColor[2] = 255;
			}
			else if (StrEqual(sBuffer_temp, "{yellow}", false)) {
				NewItem.GlowColor[0] = 199;
				NewItem.GlowColor[1] = 234;
				NewItem.GlowColor[2] = 7;
			}
			else if (StrEqual(sBuffer_temp, "{magenta}", false)) {
				NewItem.GlowColor[0] = 255;
				NewItem.GlowColor[1] = 105;
				NewItem.GlowColor[2] = 180;
			}
			else if (StrEqual(sBuffer_temp, "{silver}", false)) {
				NewItem.GlowColor[0] = 192;
				NewItem.GlowColor[1] = 192;
				NewItem.GlowColor[2] = 192;
			}
			else if (StrEqual(sBuffer_temp, "{bluegrey}", false)) {
				NewItem.GlowColor[0] = 102;
				NewItem.GlowColor[1] = 153;
				NewItem.GlowColor[2] = 204;
			}
			else if (StrEqual(sBuffer_temp, "{lightred}", false)) {
				NewItem.GlowColor[0] = 255;
				NewItem.GlowColor[1] = 90;
				NewItem.GlowColor[2] = 90;
			}
			else if (StrEqual(sBuffer_temp, "{cyan}", false)) {
				NewItem.GlowColor[0] = 0;
				NewItem.GlowColor[1] = 150;
				NewItem.GlowColor[2] = 220;
			}
			else if (StrEqual(sBuffer_temp, "{gray}", false)) {
				NewItem.GlowColor[0] = 128;
				NewItem.GlowColor[1] = 128;
				NewItem.GlowColor[2] = 128;
			}
...
public void OnEntityCreated(int iEntity, const char[] sClassname)
{
	if (IsValidEntity(iEntity))
	{
		...
		else if (StrEqual(sClassname, "func_button") || StrEqual(sClassname, "func_rot_button") || StrEqual(sClassname, "func_door") || StrEqual(sClassname, "func_door_rotating")) SDKHook(iEntity, SDKHook_SpawnPost, OnButtonSpawned);
...
public void OnTriggerSpawned(int iEntity)
{
	...
	CreateTimer(3.0, Timer_OnTriggerSpawned, iEntity);
}
